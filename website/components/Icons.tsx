...
export function LinkedInIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14M8.34 17.34V9.9H5.87v7.44h2.47M7.1 8.8a1.43 1.43 0 1 0 0-2.86 1.43 1.43 0 0 0 0 2.86m11.24 8.54v-4.08c0-2.13-.46-3.76-2.94-3.76-1.2 0-2 .65-2.32 1.27h-.04V9.9h-2.37v7.44h2.47v-3.68c0-.97.18-1.91 1.38-1.91 1.18 0 1.2 1.11 1.2 1.98v3.61h2.47Z" />
    </svg>
  );
}
